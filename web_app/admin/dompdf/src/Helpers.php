...
class Helpers
{
     ...
     * @return bool|array
     */
    public static function getFileContent($uri, $use_include_path = false,  $context = null, $offset = 0, $maxlen = null)
    {
        $result = false;
        $headers = null;
        ...
        if ($is_local_path || ini_get("allow_url_fopen")) {
            ...
            if (isset($maxlen)) {
                $result = file_get_contents($uri, $use_include_path ?? false, $context, $offset, $maxlen);
            } else {
                $result = file_get_contents($uri, $use_include_path ?? false, $context, $offset);
            }
