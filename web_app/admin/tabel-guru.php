...
<html lang="en">
    <head>
        ...
        <title>Tabel Data Guru - Halaman Admin</title>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <a class="btn btn-info mb-3" href="tambah-guru.php">Tambah Data Guru</a>
                            <table id="example" class="dataTable-table">
                                ...
                                /*  query menampilkan data semua guru di halaman admin */
                                    $dataguru = "SELECT id, nip, nama_lengkap, jenis_kelamin, tempat_lahir, tanggal_lahir, agama, golongan_darah, jenjang, no_hp, foto FROM guru";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <td>
                                            <!-- query update pada update-guru.php -->
                                            <a class="btn btn-success" href="update-guru.php?idguru=<?php echo $data['id']?>">Edit</a>
                                            <!-- query delete pada process.php -->
                                            <a class="btn btn-danger" href="process.php?deleteguru=<?php echo $data['id']?>" onclick="return confirm('Yakin ingin menghapus data?')">Delete</a>
                                        </td>
                                    </tr>
                                <?php }} ?>
                                </tbody>
