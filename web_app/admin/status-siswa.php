        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h2 class="mt-4">Data Status Siswa</h2>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <a class="btn btn-info mb-3" href="tabel-siswa.php">Data Lengkap Siswa</a>
                            <table id="datatablesSimple">
                                ...
                                /*  query menampilkan data semua siswa di halaman admin */
                                    $datasiswa = "SELECT nis, nama_lengkap, status FROM view_status_siswa";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-success" href="update-status-siswa.php?idsiswa=<?php echo $data['nis']?>">Edit</a>
                                        </td>
                                    </tr>
                                <?php }} ?>
                                </tbody>
