...
<html lang="en">
    <head>
        ...
        <title>Pengaturan Data Kelas Siswa - Halaman Admin</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h2 class="mt-4">Pengaturan Kelas Siswa</h2>
                    <a class="btn btn-info mb-3" href="tambah-pengaturankelassiswa.php">Tambah Data</a>
                    <a class="btn btn-warning mb-3" href="restore-kelas-siswa.php">Restore Data</a>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i>
                            Tabel Pengaturan Kelas Siswa
                        </div>
                        <div class="card-body">
                            ...
                            <table id="datatablesSimple">
                                ...
                                /* PEMANGGILAN VIEW view_kelas_siswa */
                                $pengaturankelassiswa = "SELECT id_atur_ks, nis, nama_siswa, kelas, tahun_pelajaran, semester, walikelas FROM view_kelas_siswa WHERE tahun_pelajaran = '$ta' AND semester = '$sem' ORDER BY nis ";
                                ...
                                if (mysqli_num_rows($kelas) > 0) {
                                    ...
                                    <tr>
                                       ...
                                       <!--  <td><?php echo $data['tahun_pelajaran'] ?></td>
                                        ...
                                        <td>
                                            <!-- query update pada update-pengaturankelassiswa.php -->
                                            <a class="btn btn-success" href="update-pengaturankelassiswa.php?idpengaturankelassiswa=<?php echo $data['id_atur_ks'] ?>">Edit</a>
                                            <!-- query delete pada process.php -->
                                            <a class="btn btn-danger" href="process.php?deletepengaturankelassiswa=<?php echo $data['id_atur_ks'] ?>" onclick="return confirm('Yakin ingin menghapus data?')">Delete</a>
                                        </td>
                                    </tr>
                                <?php }
                                }
