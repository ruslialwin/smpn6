<?php
   ...
   /* query untuk menampilkan data kegiatan(yang ingin diupdate), di halaman update data kegiatan untuk admin */
   $data_kegiatan = "SELECT judul, deskripsi, tanggal, gambar FROM kegiatan WHERE id = '".$_GET['idkegiatan']."'";
...
<html lang="en">
    <head>
        ...
        <title>Update Data Berita Kegiatan - Halaman Admin</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h2 class="mt-4">Edit Data Berita Kegiatan</h2>
                    <div class="row justify-content-center">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group mt-2">
                                <a href="tabel-kegiatan.php" class="btn btn-secondary mt-3">Kembali</a>
                                <input type="submit" class="btn btn-success mt-3 mx-3" name="updatekegiatan" value="Update">
                            </div>
                        </form>
                        <?php
                            if(isset($_POST['updatekegiatan'])) {
                                ...
                                /*  query untuk update data kegiatan di halaman admin */
                               /*  $updatekegiatan = "UPDATE kegiatan SET judul= '$judul', deskripsi='$deskripsi', tanggal = '$tanggal', gambar = '$new_image'
                                WHERE id = $idkegiatan "; */

                                /* PROCEDURE update_kegiatan */
                            $updatekegiatan = "CALL update_kegiatan($idkegiatan,'$judul','$deskripsi','$tanggal','$newname')";
                                $update = mysqli_query($koneksi, $updatekegiatan);
                                if($update){
